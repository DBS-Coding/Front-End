                        ...
                        <div className='flex flex-wrap gap-1'>
                          {Array.isArray(tag?.input) ? (
                            tag.input.slice(0, 2).map((inp, i) => (
                              <span
                                key={i}
                                className='text-xs bg-blue-900/40 px-2 py-1 rounded max-w-[150px] truncate'
                              >
                                {inp || 'N/A'}
                              </span>
                            ))
                        ...
                        <div className='flex flex-wrap gap-1'>
                          {Array.isArray(tag?.responses) ? (
                            tag.responses.slice(0, 2).map((resp, i) => (
                              <span
                                key={i}
                                className='text-xs bg-green-900/40 px-2 py-1 rounded max-w-[150px] truncate'
                              >
                                {resp || 'N/A'}
                              </span>
                            ))
                    ...
                    <div className='space-y-2 max-h-32 overflow-y-auto'>
                      ...
                      formData.input.length > 0 ? (
                        formData.input.map((inp, index) => (
                          <div
                            key={index}
                            className='flex items-center gap-2 p-2 bg-gray-800/20 rounded'
                          >
